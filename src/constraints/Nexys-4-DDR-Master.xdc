...
## Clock signal (already present, just ensure naming matches top module)
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { clk_100Mhz }]; # Sch=clk100mhz
create_clock -add -name sys_clk_pin -period 20.00 -waveform {0 10} [get_ports {clk_100Mhz}];

## Reset Button
set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { reset }]; # Sch=btnc
